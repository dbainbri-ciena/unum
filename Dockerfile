...
LABEL org.label-schema.name="unum" \
      org.label-schema.description="Provides cluster management for ONOS" \
      org.label-schema.vcs-url="https://gerrit.opencord.org/unum" \
